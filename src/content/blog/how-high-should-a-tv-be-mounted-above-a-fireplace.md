...
<div class="my-12">
  ...
  <div class="grid md:grid-cols-3 gap-4">
    ...
    <a href="/services/tv-mounting/" class="flex items-center gap-3 p-4 bg-card border border-border rounded-lg hover:border-[hsl(var(--accent))] transition-colors group">
      <span class="font-medium text-foreground group-hover:text-[hsl(var(--accent))] transition-colors">TV Mounting Services</span>
      <span class="ml-auto text-muted-foreground group-hover:text-[hsl(var(--accent))]">→</span>
    </a>
  </div>
</div>
